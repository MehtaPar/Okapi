...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        get("/low-stock", (request, response) -> {
            ...
            //return the JSON list of candies
            JSONArray candyList = new JSONArray(getLowStock());
            return getLowStock();
        });
...
/*
    public static String getLowStock() throws IOException {
        ArrayList<candy> candyInventory = new ArrayList<>();
    ...
    XSSFSheet inventory = workbook.getSheetAt(1);
        ...
        while (rowIterator.hasNext()) {
            ...
            while (cellIterator.hasNext() && index <= 4) {
                ...
                switch (index) {
                    case 1:
                        can.name = cell.getStringCellValue();
                        break;
                    case 2:
                        can.inStock = (int) (cell.getNumericCellValue());
                        break;
                    case 3:
                        can.capacity = (int) (cell.getNumericCellValue());
                        break;
                    case 4:
                        can.id = (int) (cell.getNumericCellValue());
                        break;
                }
                index++;
            }
        ...
        //converting to JSON list
        String lowStockJSON = new Gson().toJson(candyInventory);
        return lowStockJSON;
    }
*/
